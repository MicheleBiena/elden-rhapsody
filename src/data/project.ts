...
const conceptArchive: LoreConcept[] = [
  ...
  {
    id: 'incantamenti-due-dita',
    name: 'Incantamenti delle Due Dita',
    eyebrow: 'Fede, dovere e rinuncia',
    category: 'Tema',
    state: 'osservato',
    liveReadStatus: 'da-leggere',
    summary: 'Insegnamenti che chiedono ai Senzaluce di perseverare nel proprio dovere e di rifiutare tutto il resto.',
    body: 'Le descrizioni affermano: “Le Due Dita ripongono grandi speranze nei Senzaluce: anche feriti, anche caduti, continueranno a combattere per il proprio dovere”. Un altro ammonimento dice: “Ascolta, Senzaluce! Se cammini davvero nella fede, devi essere pronto a rifiutare tutto il resto”. Ne emerge una fede assoluta, fondata su perseveranza e rinuncia.',
    imageUrl: './concepts/incantamento-guarigione.png',
    imageAlt: 'L’icona dorata di un incantamento di guarigione delle Due Dita',
    evidence: ['Le Due Dita nutrono grandi speranze nei Senzaluce.', 'La caduta non deve interrompere il loro dovere.', 'La vera fede richiede di rifiutare tutto il resto.'],
    questions: ['Qual è il dovere imposto ai Senzaluce?', 'Che cosa devono essere pronti a rifiutare?'],
    tags: ['Due Dita', 'incantamenti', 'fede', 'dovere'],
    position: { x: 30, y: 93 },
  },
  {
...
export const connections: LoreConnection[] = [
  ...
  },
  {
    ...
    from: 'corhyn',
    to: 'incantamenti-due-dita',
    label: 'insegna incantamenti',
    note: 'Corhyn insegna la forza concessa dalle Due Dita.',
    kind: 'traccia',
  },
  {
  ...
  {
    id: 'incantamenti-due-dita-origine',
    from: 'incantamenti-due-dita',
    to: 'due-dita',
    label: 'forza concessa',
    note: 'Gli incantamenti sono presentati da Corhyn come una forza concessa dalle Due Dita.',
    kind: 'traccia',
  },
  {
    id: 'incantamenti-senzaluce',
    from: 'incantamenti-due-dita',
    to: 'senzaluce',
